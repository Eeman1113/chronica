...
pub struct AnimalSpecies {
    ...
    pub aquatic: bool,      // lives in the water, moves only through it
    pub t_min: f32,         // habitable temperature band (annual mean)
    pub t_max: f32,
}

pub const ANIMALS: &[AnimalSpecies] = &[
    AnimalSpecies { name: "Hare", diet: Diet::Herbivore, mass: 3.0, speed: 4, perception: 5, lifespan_y: 6.0, maturity_y: 0.6, gestation_d: 32, litter: (2, 5), hunger_rate: 0.30, herd: 0.1, prey: &[], domesticable: false, aquatic: false, t_min: -12.0, t_max: 30.0 },
    AnimalSpecies { name: "Deer", diet: Diet::Herbivore, mass: 60.0, speed: 5, perception: 7, lifespan_y: 14.0, maturity_y: 1.5, gestation_d: 200, litter: (1, 2), hunger_rate: 0.16, herd: 0.7, prey: &[], domesticable: false, aquatic: false, t_min: -15.0, t_max: 28.0 },
    AnimalSpecies { name: "Boar", diet: Diet::Omnivore, mass: 80.0, speed: 4, perception: 6, lifespan_y: 12.0, maturity_y: 1.2, gestation_d: 115, litter: (2, 6), hunger_rate: 0.18, herd: 0.4, prey: &[], domesticable: true, aquatic: false, t_min: -8.0, t_max: 30.0 },
    AnimalSpecies { name: "Wolf", diet: Diet::Carnivore, mass: 40.0, speed: 6, perception: 9, lifespan_y: 10.0, maturity_y: 1.8, gestation_d: 63, litter: (2, 5), hunger_rate: 0.14, herd: 0.6, prey: &[0, 1, 2, 5], domesticable: false, aquatic: false, t_min: -25.0, t_max: 26.0 },
    AnimalSpecies { name: "Bear", diet: Diet::Omnivore, mass: 220.0, speed: 4, perception: 8, lifespan_y: 22.0, maturity_y: 3.5, gestation_d: 220, litter: (1, 3), hunger_rate: 0.12, herd: 0.0, prey: &[0, 1, 2, 5, 8], domesticable: false, aquatic: false, t_min: -20.0, t_max: 24.0 },
    AnimalSpecies { name: "Wild Sheep", diet: Diet::Herbivore, mass: 45.0, speed: 4, perception: 6, lifespan_y: 11.0, maturity_y: 1.0, gestation_d: 150, litter: (1, 3), hunger_rate: 0.17, herd: 0.8, prey: &[], domesticable: true, aquatic: false, t_min: -18.0, t_max: 26.0 },
    AnimalSpecies { name: "Wild Horse", diet: Diet::Herbivore, mass: 300.0, speed: 8, perception: 8, lifespan_y: 24.0, maturity_y: 3.0, gestation_d: 340, litter: (1, 1), hunger_rate: 0.15, herd: 0.7, prey: &[], domesticable: true, aquatic: false, t_min: -20.0, t_max: 28.0 },
    AnimalSpecies { name: "Aurochs", diet: Diet::Herbivore, mass: 500.0, speed: 4, perception: 6, lifespan_y: 18.0, maturity_y: 2.5, gestation_d: 280, litter: (1, 1), hunger_rate: 0.20, herd: 0.7, prey: &[], domesticable: true, aquatic: false, t_min: -15.0, t_max: 28.0 },
    AnimalSpecies { name: "River Trout", diet: Diet::Herbivore, mass: 2.0, speed: 3, perception: 4, lifespan_y: 7.0, maturity_y: 0.8, gestation_d: 40, litter: (3, 8), hunger_rate: 0.10, herd: 0.5, prey: &[], domesticable: false, aquatic: true, t_min: -30.0, t_max: 30.0 },
];

pub const A_HARE: u8 = 0;
pub const A_FISH: u8 = 8;
